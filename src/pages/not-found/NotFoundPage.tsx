  ...
  return (
    <section className="mx-auto flex min-h-[62vh] w-[92%] max-w-4xl items-center py-14">
      <div className="premium-panel w-full rounded-3xl p-8 text-center sm:p-10">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full border border-[#c69a86]/30 bg-[#c69a86]/10 text-[#c69a86]">
        ...
        <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-[#6d554b] sm:text-base">
          La ruta que buscas no existe o fue movida. Puedes volver al inicio y
          continuar navegando por CQUEZADASKIN.
        </p>
        <Button
          asChild
          className="mt-7 rounded-2xl bg-[#c69a86] font-semibold text-[#4b3932] hover:bg-[#e8c2b5]"
        >
